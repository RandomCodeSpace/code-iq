...
export const TOOLS: McpTool[] = [
  // -- Statistics --
  {
    ...
    category: "stats", params: [], url: "/api/stats",
  },
  {
  ...
  },
  {
    ...
    category: "query", params: [], url: "/api/kinds",
  },
  {
  ...
  // -- Service Topology --
  {
    ...
    category: "topology", params: [], url: "/api/topology",
  },
  {
    name: "service_detail",
  ...
  },
  {
    ...
    category: "flow", params: [], url: "/api/flow",
  },
  ...
  // -- Security --
  {
    ...
    category: "security", params: [], url: "/api/flow/auth?format=json",
  },
